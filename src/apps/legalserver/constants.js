...
const EVENT_CURRENT_USER_API_FALLBACK_RANGE_MAX_DAYS = 14;
const EVENT_DATE_FALLBACK_MAX_PAGES = 20;
const MATTER_CURRENT_USER_SCAN_MAX_PAGES = 10;
const DEFAULT_MATTER_CURRENT_USER_CACHE_TTL_MS = 60000;
const DEFAULT_MATTER_CURRENT_USER_FETCH_CONCURRENCY = 4;
const MAX_MATTER_CURRENT_USER_FETCH_CONCURRENCY = 8;
...
const DEFAULT_DOCUMENT_OCR_MAX_PAGES = 50;
